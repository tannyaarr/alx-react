...
describe('getAllNotificationsByUser function', () => {
  test('getAllNotificationsByUser returns correct notifications for userId 5debd764a7c57c7839d722e9', () => {
...
describe('Normalized Data', () => {
  test('Should have correct result array', () => {
  ...
  test('Should have correct users entity', () => {
    const expectedUser = {
      age: 25,
  ...
  test('Should have correct messages entity', () => {
  ...
  test('Should have correct notifications entity', () => {
